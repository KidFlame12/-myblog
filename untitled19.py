...
root.title("Internent Speed Test")
root.geometry("500x300")

label = Label(root ,text="Internent Speed Check", font=("Lucida Sans Unicode", 20, "bold","italic"), fg="#5d6d7e", bg="#dee8f1")
label.place(relx=0.5, rely=0.1,anchor=CENTER)

label_download(root ,text="Download Speed ↓", font=("Segoe Print", 18, "bold",), fg="#1E8449", bg="#dee8f1")
label_download.place(relx=0.25, rely=0.5,anchor=CENTER)


label_upload(root ,text="Upload Speed ☝︎", font=("Segoe Print", 18, "bold",), fg="#9BS9B6", bg="#dee8f1")
label_upload.place(relx=0.75, rely=0.5,anchor=CENTER)


label_download_speed(root , font=("Yu Gothic Light", 14, "bold",), bg="#dee8f1")
label_download_speed.place(relx=0.25, rely=0.6,anchor=CENTER)

label_upload_speed(root , font=("Yu Gothic Light", 14, "bold",), bg="#dee8f1")
